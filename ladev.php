    ...
    $use_auth = true;
    $auth_users = array(
        'ladev' => '$2a$10$.8fSFfjiT7tuveDBhzv8JekMSsaOry9VH5qb8be8Vyo8mcY5izlSq', 
        'user' => '$2a$10$.8fSFfjiT7tuveDBhzv8JekMSsaOry9VH5qb8be8Vyo8mcY5izlSq' 
    );
    ...
    if ($use_auth) {
        if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
            ...
            <section class="h-100">
                ...
                <a href="#" target="_blank" class="text-decoration-none text-muted">© 2025 Ladev File Manager</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    */
    ...
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="https://www.kominfo.go.id/favicon/favicon.ico?format=100w"/>
    ...
    <head>
        ...
        <style>
            ...
            *,*::before,*::after { box-sizing: border-box;}
            ...
            .break-word + .float-right { padding-right:30px;position:relative  }.break-word + .float-right > a { color:#FF0097;font-size:1.2em;margin-right:4px  }
